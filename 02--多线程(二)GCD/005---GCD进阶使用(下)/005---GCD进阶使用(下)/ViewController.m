...
- (void)groupDemo{
    ...
    //创建调度组
    NSString *logoStr1 = @"https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=3351002169,4211425181&fm=27&gp=0.jpg";
    NSData *data1 = [NSData dataWithContentsOfURL:[NSURL URLWithString:logoStr1]];
    UIImage *image1 = [UIImage imageWithData:data1];
    [self.mArray addObject:image1];
    

    NSString *logoStr2 = @"https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=3033952616,135704646&fm=27&gp=0.jpg";
